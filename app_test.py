...
def get_args():
    ...
    # Add serial port argument - Change 'COM3' or '/dev/ttyACM0' to your port
    ...
    while True:
        ...
        if results.multi_hand_landmarks is not None:
            for hand_landmarks, handedness in zip(results.multi_hand_landmarks,
                ...
                if ser is not None and hand_sign_id != "Not applicable":
                    # Send the ID as a string character ('0', '1', etc.)
                    ser.write(str(hand_sign_id).encode())
                #############################################################
...
# ... (rest of your helper functions: select_mode, calc_bounding_rect, etc. remain the same)
